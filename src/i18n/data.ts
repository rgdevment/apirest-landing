...
export const siteData = {
  es: {
    ...
    hero: {
      ...
      title:
        "Software por convicción, <br/> <span class='text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-300'>no por suscripción.</span>",
      subtitle:
        "Mantenemos servicios esenciales y herramientas de productividad para desarrolladores. <strong class='text-slate-200'>Sin tracking. Sin barreras. Sin costo.</strong>",
    ...
    services: [
      {
        title: 'Indicadores Chile',
        description:
          'Servicio de datos económicos en tiempo real (UF, UTM, Dólar). API REST pública y gratuita diseñada para integraciones críticas sin depender de scrapers inestables.',
        url: 'https://github.com/rgdevment/open-data-service/tree/main/apps/indicators',
        type: 'API',
        status: 'online',
      ...
      },
      {
        ...
        url: 'https://github.com/rgdevment/open-data-service/tree/main/apps/countries',
        type: 'API',
        status: 'online',
      ...
      },
      {
        title: 'CopyPaste',
        description:
          'Gestor de portapapeles de escritorio para Windows (WinUI 3). Historial seguro, búsqueda rápida y almacenamiento local. Sin nubes obligatorias ni telemetría invasiva.',
    ...
    mission: {
      ...
      text2:
        "Nuestra motivación es simple: <span class='text-slate-200 font-semibold'>Democratizar la infraestructura.</span> Creemos que acceder a indicadores económicos básicos o herramientas de productividad no debería requerir una tarjeta de crédito ni ceder tu privacidad.",
      text3:
  ...
  en: {
    ...
    hero: {
      ...
      title:
        "Software by conviction, <br/> <span class='text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-cyan-300'>not subscription.</span>",
      subtitle:
        "We maintain essential services and productivity tools for developers. <strong class='text-slate-200'>No tracking. No barriers. No cost.</strong>",
    ...
    services: [
      {
        title: 'Indicadores Chile',
        description:
          'Real-time economic data service (UF, UTM, Dollar). Free public REST API designed for critical integrations without relying on unstable scrapers.',
        url: 'https://github.com/rgdevment/open-data-service/tree/main/apps/indicators',
        type: 'API',
        status: 'online',
        icon: 'M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6',
      ...
      },
      {
        title: 'CopyPaste',
        description:
          'Desktop clipboard manager for Windows (WinUI 3). Secure history, fast search, and local storage. No mandatory clouds or invasive telemetry.',
        url: 'https://github.com/rgdevment/CopyPaste',
        type: 'APP',
        status: 'beta',
        icon: 'M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2',
    ...
    mission: {
      ...
      text2:
        "Our motivation is simple: <span class='text-slate-200 font-semibold'>Democratize infrastructure.</span> We believe accessing basic economic indicators or productivity tools shouldn't require a credit card or surrendering your privacy.",
      text3:
